...
// }
void AdminDashboard::saveEventsToFile(const std::vector<Event>& events, const std::string& fileName) {
...
void AdminDashboard::loadUsersFromFile() {
    QFile file("C:\\Users\\hemac\\OneDrive\\Desktop\\users.txt");
    if (!file.open(QIODevice::ReadOnly | QIODevice::Text)) {
        QMessageBox::critical(this, "Error", "Unable to open the users file.");
        return;
    }
    ...
    QMessageBox::information(this, "File Contents", fileContents.isEmpty() ? "The file is empty." : fileContents);
}
    ...
    void AdminDashboard::loadEventsFromFile() {
        ...
        QString filePath = "C:\\Users\\hemac\\OneDrive\\Desktop\\users.txt";
